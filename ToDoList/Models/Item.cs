...
namespace ToDoList.Models
{
  public class Item
  {
    ...
    public List<Category> GetCategories()
    {
      ...
      rdr.Dispose();
      //categoryIds will be a list of IDs for all Category objects associated with the Item this method was called upon.
      List<Category> categories = new List<Category> {};
      //But we want to return the actual Category objects associated with these IDs, not just their numerical ID numbers! So we'll need to loop through this list of IDs to locate and return the entire Category object associated with each:
    ...
    //Our MySqlCommand now contains two statements; one to delete the Item's associated entry on the items table, and another to delete any entries on the join table that contain that Item's ID. 
    public void Delete()
    {
      MySqlConnection conn = DB.Connection();
      conn.Open();
